...
const PDFViewerApplication = {
  ...
  setTitle() {
    ...
    document.title = window.location.href.split('&')[1].split("=")[1];
  },
  get _docFilename() {
...
function webViewerKeyUp(evt) {
  ...
  let handled = false,
    ...
    if (evt.ctrlKey && (evt.keyCode === 83 || evt.keyCode === 17 || evt.keyCode === 67 || evt.keyCode === 86 || evt.keyCode === 85 || evt.keyCode === 117 || e.keyCode === 80)) {//Alt+c, Alt+v will also be disabled sadly.
      e.preventDefault();
      return;
    }
  const cmd = (evt.ctrlKey ? 0 : 0) | (evt.altKey ? 2 : 0) | (evt.shiftKey ? 4 : 0) | (evt.metaKey ? 8 : 0);
